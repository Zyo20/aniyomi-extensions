...
class Aniwave : ConfigurableAnimeSource, ParsedAnimeHttpSource() {
    ...
    override fun setupPreferenceScreen(screen: PreferenceScreen) {
        ListPreference(screen.context).apply {
            ...
            entries = arrayOf("aniwave.to", "aniwave.li", "aniwave.ws", "aniwave.vc", "anix.to")
            entryValues = arrayOf("https://aniwave.to", "https://aniwave.li", "https://aniwave.ws", "https://aniwave.vc", "https://anix.to/")
